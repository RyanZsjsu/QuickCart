             ...
             implements SearchTreeInterface<T>
{
  ...
  public BinarySearchTree(){
     super(); 
    a = new Item[DEFAULT_CAPACITY];
    j = new Item[DEFAULT_CAPACITY];
  }
                                  ...
                                  BinaryTreeInterface<T> rightTree)
  {
        ...
        public T getSearchEntry() 
	{
        ...
        public Item[] returnCategory(T entry){
            BinaryNodeInterface<T> currentNode = getRootNode();
            return this.returnCategory(entry, currentNode);
        }
        private Item[] returnCategory(T entry , BinaryNodeInterface<T> root){
            boolean found = false;
          
                T currentEntry = root.getData();
                //System.out.println(entry.equals(currentEntry));
                if (entry.equals(currentEntry) && currentEntry != null){
                    a[x] = (Item) currentEntry;
                    x++;
                   System.out.println(x);
                   if(x == a.length){
                            Item[] newArray = Arrays.copyOf(a, x + DEFAULT_CAPACITY);
                          a = newArray;
                       }
                   }
                ...
                {
                    returnCategory(entry , root.getLeftChild());
                }
                if (root.getRightChild() != null){
                    returnCategory(entry ,root.getRightChild());
                }
        ...
        public LinkedList returnId(T entry){
            BinaryNodeInterface<T> currentNode = getRootNode();
            return this.returnId(entry, currentNode);
        }
        private LinkedList returnId(T entry , BinaryNodeInterface<T> root){
            boolean found = false;
          
                T currentEntry = root.getData();
                comparator2 h = new comparator2();
                
                //System.out.println(entry.equals(currentEntry));
                if (h.compare( (Item) entry, (Item) currentEntry) == 0 && currentEntry != null){
                    list.add(currentEntry);
                    j[v] = (Item) currentEntry;
                    v++;
                   System.out.println(v);
                   if(v == j.length){
                            Item[] newArray = Arrays.copyOf(j, v + DEFAULT_CAPACITY);
                          j = newArray;
                       }
                ...
                if (root.getLeftChild() != null)
                {
                    returnId(entry , root.getLeftChild());
                }
                if (root.getRightChild() != null){
                    returnId(entry ,root.getRightChild());
                }
